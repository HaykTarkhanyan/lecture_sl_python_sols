...
::: callout-tip
You can run the notebooks in Google Colab here: [R](https://colab.research.google.com/github/HaykTarkhanyan/lecture_sl_python_sols/blob/main/exercises/ARM_03/sol_advriskmin_3_R.ipynb), [Python](https://colab.research.google.com/github/HaykTarkhanyan/lecture_sl_python_sols/blob/main/exercises/ARM_03/sol_advriskmin_3_py.ipynb).
:::
...
As we can see the conjecture is quite reasonable, and we experiance a big residual only for the point $x \backsimeq  205$.
